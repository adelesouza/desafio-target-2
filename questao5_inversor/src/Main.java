...
public class Main {
    public static void main(String[] args) {
        ...
        int i;
        for (i = (listaTextoSeparado.size())-1; i >= 0; i--)
        { listaTextoInvertido.add(listaTextoSeparado.get(i)); }

        for (i = 0; i < listaTextoInvertido.size(); i++)
        { construtorTextoInvertido.append(listaTextoInvertido.get(i));}
